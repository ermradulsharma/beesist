...
class EngagementEmail3ConsultRequest extends Command
{
     ...
     * @var string
     */
    protected $signature = 'get_quote:consult_request';
     ...
     * @var string
     */
    protected $description = 'ENGAGEMENT EMAIL #3 CONSULT REQUEST';
    ...
    public function handle()
    {
        ...
        if ($email_data->status == '1') {
            ...
            foreach ($quotes as $quote) {
                ...
                $quote_update = QuoteRequests::find($quote->id)->update(['notify_status' => 4]);
            }
            if ($additional) {
