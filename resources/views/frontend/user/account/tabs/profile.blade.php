<div class="table-responsive">
    <table class="table table-striped table-hover table-bordered mb-0">
        ...
        <tr>
            <th>@lang('Avatar')</th>
            <td>
                <img src="{{ $logged_in_user->image ? asset('uploads/profile/'.$logged_in_user->id.'/'.$logged_in_user->image) : $logged_in_user->avatar }}" class="user-profile-image" />
                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal"><i class="fas fa-user-edit x"></i></a>
            </td>
        </tr>
...
@endphp
<x-modal.fileUploadModal :user="$logged_in_user" :routeName="$routeName" />
