...
@props(['slug'])
<div id="RegisterModal" class="modal fade authModals" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="account-wall" style="padding: 10px;">
                    ...
                    @captcha()
                    <form id="registerForm" class="form-signin" method="POST" action="#">
                        @csrf
                        <div class="row mb-1">
                            <div class="col-md-6">
                        ...
                        <div class="form-group text-start mb-1">
                            ...
                            <div class="input-group mb-1">
                                ...
                                <input id="email" type="email" class="form-control rentalEmail" name="email" value="" placeholder="Email" autocomplete="new-email">
                        ...
                        <div class="form-group text-start mb-2">
                            ...
                            <label class="form-check-label" for="terms">
                                @lang('I agree to the') <a href="{{ $slug ? route('dynamic.termsConditions', ['subdomain' => $slug]) : route('frontend.terms')}}" target="_blank">@lang('Terms & Conditions')</a>
                            </label>
                        ...
                        @endif
                        <div class="form-group loginBtn d-flex flex-column gap-1">
                            ...
                            <button id="skipRegister" onclick="gotoApplication();" class="btn btn-light rounded-pill px-4 border-0 text-uppercase" type="button" style="width: 100%;"><small> Skip for now </small></button>
                        </div>
                    </form>
                    <hr class="my-2">
                    <p style="text-align: center"><small>By creating an account you agree to our <br><a href="{{ $slug ? route('dynamic.privacyPolicy', ['subdomain' => $slug]) :  route('frontend.privacy') }}">Privacy Policy</a> and <a href="{{ $slug ? route('dynamic.termsConditions', ['subdomain' => $slug]): route('frontend.terms')}}">Terms of Service</a>.<br>Already have an account?</small><br><a href="javascript:void(0)" title="Sign in" onclick="gotoLoginPopup()">Sign in</a></p>
                </div>
            </div>
        </div>
    </div>
