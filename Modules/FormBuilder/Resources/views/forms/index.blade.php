                            ...
                            <tbody>
                                @foreach ($forms as $form)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm clipboard" data-clipboard-text='[form_builder id="{{ $form->identifier }}"]' data-message='[form_builder id="{{ $form->identifier }}"]' data-original='[form_builder id="{{ $form->identifier }}"]' title="Copy Shortcode">
                                                [form_builder id="{{ $form->identifier }}"]
                                            </button>
                                        </td>
                                        <td>
