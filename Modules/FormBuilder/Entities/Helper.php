...
class Helper
{
    ...
    {
        if (empty(config('formbuilder.roles_provider'))) {
            return [];
        }
    ...
    public static function formShortcode($identifier): string
    {
        $form = Form::where('identifier', $identifier)->firstOrFail();
        $form_html = view('formbuilder::render.shortcode', compact('form'));
